...
import { PRODUCTS, GUESS_GAME } from "@/lib/content/chapter";
          ...
          return (
            ...
            >
              ...
              {/* Redacted bar (build4 §7.1) that morphs into an outlined,
                  ...
                  remount, via Motion's `layout` prop. The wrapper stays the
                  flex-growing box; the button itself stays content-sized
                  (a bar) until the game claims the full row (a card). */}
