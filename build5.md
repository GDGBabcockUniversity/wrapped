...
// TBD-owner except Xavier's (already in /public/people). "Daddy D the
// Designer" is the requested display name — identity/photo TBD-confirm.
export const SPECIAL_FORCE = [
  ...
  { name: "Daddy D the Designer", photo: null },
] as const;
```
