export const copy = {
  ...
  yourRadar: {
    setup: "You were reading. We were counting.",
    readsReveal: "{reads} pieces read on RADAR.",
    readsRevealOne: "One piece read on RADAR. It still counts.",
    minutes: "{minutes} minutes of your attention.",
    minutesShort: "Short and sweet.",
    playsOnly: "{plays} games played.",
    plays: "And {plays} games played.",
    streak: "Longest run: {streak} days straight.",
    topGame: "{game} was your game.",
    activeDays: "{days} days you showed up for.",
  },
  standing: {
  ...
  grid: {
    ...
    "group-chat": "The main chat, audited.",
    people: "Roll credits.",
    "your-events": "Your attendance record.",
    "your-radar": "What you read and played.",
